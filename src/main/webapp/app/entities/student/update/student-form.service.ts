...
type StudentFormGroupContent = {
  ...
  enrollmentDate: FormControl<IStudent['enrollmentDate']>;
  graduationDate: FormControl<IStudent['graduationDate']>;
  photo: FormControl<IStudent['photo']>;
  photoContentType: FormControl<IStudent['photoContentType']>;
  homeAddress: FormControl<IStudent['homeAddress']>;
  emergencyContact: FormControl<IStudent['emergencyContact']>;
  parent: FormControl<IStudent['parent']>;
};
...
export class StudentFormService {
  createStudentFormGroup(student: StudentFormGroupInput = { id: null }): StudentFormGroup {
    ...
    return new FormGroup<StudentFormGroupContent>({
      ...
      graduationDate: new FormControl(studentRawValue.graduationDate),
      photo: new FormControl(studentRawValue.photo, {
        validators: [Validators.required],
      }),
      photoContentType: new FormControl(studentRawValue.photoContentType),
      homeAddress: new FormControl(studentRawValue.homeAddress, {
        validators: [Validators.required],
      }),
      emergencyContact: new FormControl(studentRawValue.emergencyContact, {
        validators: [Validators.required],
      }),
      parent: new FormControl(studentRawValue.parent),
    });
  }
