...
class StudentResourceIT {
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getHomeAddress()).isEqualTo(DEFAULT_HOME_ADDRESS);
        assertThat(testStudent.getEmergencyContact()).isEqualTo(DEFAULT_EMERGENCY_CONTACT);
    }
    ...
    void checkEmergencyContactIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setEmergencyContact(null);
    ...
    void putExistingStudent() throws Exception {
        ...
        assertThat(testStudent.getHomeAddress()).isEqualTo(UPDATED_HOME_ADDRESS);
        assertThat(testStudent.getEmergencyContact()).isEqualTo(UPDATED_EMERGENCY_CONTACT);
    }
