...
import com.mycompany.school.domain.Course;
import com.mycompany.school.repository.CourseRepository;
...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).credits(DEFAULT_CREDITS);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).credits(UPDATED_CREDITS);
        return course;
    }
    ...
    void putExistingCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).credits(UPDATED_CREDITS);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).credits(UPDATED_CREDITS);
